...
export function SocialFAQ() {
  return (
    <ServiceFaqSection
      ...
      description="All eleven questions from the original page are included."
      items={content.faqs}
      group="social-faq"
      tone="mist"
...
export function SocialFinalCTA() {
  return <section className="bg-[#76a9e8] text-[#10243a]"><div className="container-omh section-md grid grid-cols-12 items-center gap-10 max-lg:block"><Reveal className="col-span-8"><p className="text-[12px] font-semibold uppercase tracking-[0.16em] text-[#10243a]/55">Free consultation · Get in touch</p><h2 className="mt-5 max-w-[19ch] font-sans text-h2 font-semibold">Need help with one of our services?</h2><p className="mt-5 max-w-[58ch] text-lead leading-relaxed text-[#10243a]/70">Book a call at a convenient time, or speak to the team on <a className="font-semibold underline underline-offset-4" href={company.phoneHref}>{company.phoneDisplay}</a>.</p></Reveal><Reveal className="col-span-4 max-lg:mt-8"><Button href="/contact" variant="inverse" arrow data-event="social_final_cta_click">Book a Free Consultation</Button></Reveal></div></section>;
}
