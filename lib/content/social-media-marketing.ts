export const socialMediaMarketing = {
  ...
  goals: [
    ...
    "Where does that audience spend time, and how do they use social media?",
    "What message do you want to send through your social channels?",
  ],
  support: [
    { title: "Content creation", body: "We create on-brand copy and visual assets that showcase your product or service clearly, supported by experienced graphic designers." },
    { title: "Custom social graphics", body: "From eye-catching advertising creative to reusable post templates, we can build a tailored design package around your needs." },
    { title: "Profile and cover design", body: "We design the first visual touchpoints potential customers see, helping each account feel clear, consistent and connected to your wider brand." },
    { title: "Social media optimisation", body: "We review how your accounts are set up across channels such as Instagram, Facebook and X, then recommend the right optimisation package." },
    { title: "Account refresh", body: "Already active on social? We can audit your existing business accounts and recommend practical improvements so they represent your business consistently." },
    { title: "Community and review management", body: "We monitor conversations, forums and reviews, respond in your tone of voice and escalate important opportunities or issues for your team to handle." },
  ],
  packages: [
    { name: "Seed", price: "£450", bestFor: "A focused starting point for Facebook and X.", features: ["Brand creation: not included", "3-month contract", "8 Facebook posts", "8 X / Twitter posts", "Instagram posts: not included", "LinkedIn posts: not included", "Google posts: not included", "1 social media page created", "2 social media pages optimised", "Monthly meeting", "24-hour onboarding", "Hashtag research", "Organic following strategy: not included", "Monthly reporting"] },
